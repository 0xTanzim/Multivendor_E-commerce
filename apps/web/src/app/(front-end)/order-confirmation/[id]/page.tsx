...
const OrderConfirmationPage = async ({
  ...
  const orderData = await getData(`orders/${orderId}`);
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative mt-6 overflow-hidden bg-white dark:bg-slate-700 rounded-lg shadow md:mt-10">
              <div className="absolute top-4 right-4">
                <button
                  type="button"
                  className="inline-flex items-center justify-center px-4 py-3 text-xs font-bold text-slate-900 transition-all duration-200 bg-slate-100 border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 hover:bg-slate-200"
                >
                  View invoice
                </button>
              </div>
              ...
              <div className="px-4 py-6 sm:px-8 sm:py-10">
                <div className="-my-8 divide-y divide-slate-200">
                  <div className="pt-16 pb-8 text-center sm:py-8">
                    <CheckCircle2 className="w-10 h-10 mx-auto text-lime-500" />

                    <h1 className="mt-4 text-2xl font-bold text-slate-900 dark:text-lime-50">
                  ...
                  <div className="py-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 sm:gap-x-20">
                      <div>
                        <h2 className="text-xs font-bold tracking-widest text-slate-400 uppercase dark:text-slate-500">
                          Shipping Address
                        </h2>
                  ...
                  <div className="py-8">
                    ...
                    <div className="flow-root mt-8">
                      <ul className="divide-y divide-slate-200 -my-7">
                        {orderItems &&
                          orderItems.length > 0 &&
                              ...
                              >
                                <div className="flex items-stretch">
                                  ...
                                  <div className="flex flex-col justify-between ml-5 w-44">
                                    <p className="flex-1 text-sm font-bold text-slate-900 dark:text-slate-300">
                                      {item.title}
                                    </p>
                                ...
                                <div className="ml-auto">
                                  <p className="text-sm font-bold text-right text-slate-900 dark:text-slate-300">
                                    ${item.price}
                                  </p>
                                </div>
                              </li>
