      ...
      <div className="space-y-8">
        <div className="space-y-4">
          {products.map((product) => {
            ...
            const sellPrice = typeof product.sellPrice === 'number' ? product.sellPrice : product.productPrice;
            const discountAmount = product.productPrice - sellPrice;
            const discountPercentage =
              product.productPrice > 0
                ? Math.round((discountAmount / product.productPrice) * 100)
                : 0;
                        ...
                        {discountPercentage > 0 ? (
                          <>
                            <span className="text-lg font-bold text-lime-600 dark:text-lime-400">
                              ${typeof product.sellPrice === 'number' ? product.sellPrice.toFixed(2) : 'N/A'}
                            </span>
